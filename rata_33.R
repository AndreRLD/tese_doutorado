...
rata= read.table("VO2pos_ID33_07_08_2022.mtb", header = TRUE)
...
vo2= ((rata$fluxo * (c_o2e/100)) - rata$fluxo * (1 - c_o2e/100) / (1 - rata$o2/100 - rata$co2/100) * (rata$o2/100))/ (df1$peso[df1$id==33]^0.75)

vco2= (rata$fluxo * ((1- c_o2e/100)/ (1- rata$o2/100 - rata$co2/100)) * (rata$co2/100) - rata$fluxo * c_co2e/100) / (df1$peso[df1$id==33]^0.75)
